...
namespace TelephoneDirApi.Controllers
{
    ...
    public class PersonController : ControllerBase
    {
        ...
        public PersonController(PersonRepository personRepository,GenderRepository genderRepository, CityRepository cityRepository, StateRepository stateRepository, CountryRepository countryRepository)
        {
